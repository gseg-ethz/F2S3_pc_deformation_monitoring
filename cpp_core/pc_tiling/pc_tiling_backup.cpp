									...
									std::string saveFilePrefix)
{
	...
	{
		// checj in which direction the point cloud is projected
		if (projectionDirection == 0) 
		{
			...
			if (side_1 > side_2) 
			{
				...
				// Filter out part 1
				minPT_1.y = maxPT_1.y - side_1 / 2 - EPS - overlap;
				...
				// Filter out part 2
				maxPT_2.y = maxPT_2.y - side_1 / 2 + EPS + overlap;
				...
				split_point_clouds_into_tiles(cloudEpoch1_1, cloudEpoch2_1, minPT_1, maxPT_1, maxPointsPerTile, minPointsPerTile, tileCounter, projectionDirection, overlap, saveFilePrefix);
				split_point_clouds_into_tiles(cloudEpoch1_2, cloudEpoch2_2, minPT_2, maxPT_2, maxPointsPerTile, minPointsPerTile, tileCounter, projectionDirection, overlap, saveFilePrefix);
			...
			else 
			{
				...
				// Filter out part 1
				minPT_1.z = maxPT_1.z - side_2 / 2 - EPS - overlap;
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch1_1(new pcl::PointCloud<pcl::PointXYZ>);
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch2_1(new pcl::PointCloud<pcl::PointXYZ>);
				filter_based_on_bb(cloudOne, cloudEpoch1_1, minPT_1, maxPT_1);
				filter_based_on_bb(cloudTwo, cloudEpoch2_1, minPT_1, maxPT_1);
				...
				// Filter out part 2
				maxPT_2.z = maxPT_2.z - side_2 / 2 + EPS + overlap;
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch1_2(new pcl::PointCloud<pcl::PointXYZ>);
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch2_2(new pcl::PointCloud<pcl::PointXYZ>);
				filter_based_on_bb(cloudOne, cloudEpoch1_2, minPT_2, maxPT_2);
				filter_based_on_bb(cloudTwo, cloudEpoch2_2, minPT_2, maxPT_2);
		...
		else if (projectionDirection == 1) 
		{
			...
			if (side_1 > side_2)
			{
				...
				// Filter out part 2
				maxPT_2.x = maxPT_2.x - side_1 / 2 + EPS + overlap;
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch1_2(new pcl::PointCloud<pcl::PointXYZ>);
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch2_2(new pcl::PointCloud<pcl::PointXYZ>);
				filter_based_on_bb(cloudOne, cloudEpoch1_2, minPT_2, maxPT_2);
				filter_based_on_bb(cloudTwo, cloudEpoch2_2, minPT_2, maxPT_2);
		...
		else
		{
			...
			else
			{
				...
				// Filter out part 1
				minPT_1.y = maxPT_1.y - side_2 / 2 - EPS - overlap;
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch1_1(new pcl::PointCloud<pcl::PointXYZ>);
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch2_1(new pcl::PointCloud<pcl::PointXYZ>);
				filter_based_on_bb(cloudOne, cloudEpoch1_1, minPT_1, maxPT_1);
				filter_based_on_bb(cloudTwo, cloudEpoch2_1, minPT_1, maxPT_1);
				...
				// Filter out part 2
				maxPT_2.y = maxPT_2.y - side_2 / 2 + EPS + overlap;
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch1_2(new pcl::PointCloud<pcl::PointXYZ>);
				pcl::PointCloud<pcl::PointXYZ>::Ptr cloudEpoch2_2(new pcl::PointCloud<pcl::PointXYZ>);
				filter_based_on_bb(cloudOne, cloudEpoch1_2, minPT_2, maxPT_2);
				filter_based_on_bb(cloudTwo, cloudEpoch2_2, minPT_2, maxPT_2);
					   ...
					   bool verbose)
{
	...
	split_point_clouds_into_tiles(cloudEpoch1, cloudEpoch2, bbOverlapMin, bbOverlapMax, maxPointsPerTile, minPointsPerTile, tileCounter, projectionDirection, overlapTiles, saveFilePrefix);
